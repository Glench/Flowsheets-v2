...
class TextDiffVizOptions extends React.Component {
    ...
    render() {
        return React.createElement('div', null, [React.createElement('div', null, React.createElement('label', null, 'compare against: '), React.createElement('input', { value: this.state.compare_against, onChange: this.change_compare_against, size: this.state.compare_against.length || 4, key: 'compare_against' })), React.createElement('div', null, [React.createElement('input', { type: 'checkbox', value: this.state.show_additions, onChange: this.change_show_additions, key: 'show_additions' }), React.createElement('label', null, 'show additions')]), React.createElement('div', null, [React.createElement('input', { type: 'checkbox', value: this.state.show_deletions, onChange: this.change_show_deletions, key: 'show_deletions' }), React.createElement('label', null, 'show deletions')])]);
    }
}
